...
        /* --- GAME LOGIC START (Updated to CARD_COUNT = 20) --- */
...
        ];
        
        // KEY CHANGE: Set the total number of questions back to 20
        const CARD_COUNT = 20; 
...
            // UPDATED MESSAGE: 20 Questions
            statusMessage.textContent = `Challenge: Sort ${CARD_COUNT} algebraic items by type!`;
...
        /* --- GAME LOGIC END (Updated to CARD_COUNT = 20) --- */
    </script>
</head>
